...
@Component({
  selector: 'app-mon-publication',
  templateUrl: './mon-publication.component.html',
  styleUrls: ['./mon-publication.component.scss']
})
...
//   ],
// })
export class MonPublicationComponent implements OnInit {
